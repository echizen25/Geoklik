 ...
 *
 * Project municipality/barangay enforcement is intentionally not part of this
 * state manager for now. Capture availability is controlled only by the normal
 * GeoKlik requirements (selected capture target, GPS quality/stability and the
 * active capture lifecycle). This restores the proven pre-geofence behavior.
 */
